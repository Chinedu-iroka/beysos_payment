...
urlpatterns = [
    ...
    path('api/buy-prompt-bulk/',       views.buy_prompt_bulk,       name='buy_prompt_bulk'),
    path('api/send-bulk-prompt-email/', views.send_bulk_prompt_email, name='send_bulk_prompt_email'),
